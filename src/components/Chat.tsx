...
const Chat: React.FC = () => {
  ...
  return (
      <>
        {!isExpanded && (
            <button
                className={`fixed w-16 h-16 flex items-center justify-center rounded-full shadow-lg border-gray-300 bg-white text-black transition-colors duration-300 ease-in-out
        ...
        `}
            ...
            ${isExpanded || isMobile ? "w-full md:max-w-2xl" : "w-96"}
          `}
              >
